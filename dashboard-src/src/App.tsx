    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <form onSubmit={recordSale} className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <label className="text-[11px] font-medium text-zinc-400">Price each<input required min="0" step="0.01" type="number" value={form.unitPrice} onChange={(event) => setForm((current) => ({ ...current, unitPrice: event.target.value }))} placeholder="0.00" className={`mt-1.5 ${tireFieldClass}`} /></label>
